    ...
    <div class="form-row mb-2">
        ...
        {{ component('subscriptions/subscription-selector', {
            ...
            subscription_classes: {
                ...
                cart_alert: 'font-small text-center mb-4 subscription-btn-alert',
                ...
                legal_message: 'font-small text-center w-100 mb-1',
                legal_link: 'font-small btn-link btn-link-primary p-0',
                ...
                legal_modal_title: 'col offset-2 text-center',
                legal_modal_close_button: 'col-2 mr-0 text-right',
